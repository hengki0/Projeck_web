    ...
    <body class="theme-teal">
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">PENJUALAN BARANG COMPUTER </a>
                </div>
        ...
        <section>
            <aside id="leftsidebar" class="sidebar">
                <div class="user-info">
                    <div class="image">
                        <img src="foto.png" width="50" height="50" alt="User" />
                    </div>
                ...
                <div class="legal">
                    <div class="copyright">
                        <?php echo tgl_indo(date('Y-m-d')); ?> | Belajar di <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
